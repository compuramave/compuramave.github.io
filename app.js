...
async function loadProductsFromSheet() {
  try {
    ...
    products = dataRows.map(row => {
      ...
      const componentKeywords = ['motherboard', 'tarjeta madre', 'tarjeta de video', 'tarjeta grafica', 'memoria ram', 'procesador', 'cpu', 'gpu', 'gtx', 'rtx', 'gt ', 'rx ', 'geforce', 'radeon', 'ssd', 'disco duro', 'nvme', 'm.2', 'fuente de poder', 'power supply', 'psu', 'chasis', 'case gamer', 'cooler', 'disipador', 'ddr'];
      
      const isLaptop = (laptopKeywords.some(kw => titleLower.includes(kw)) || screenSizes.some(sz => titleLower.includes(sz)) || (hasSystemBrand && !componentKeywords.some(kw => titleLower.includes(kw)))) && !titleLower.includes('all in one') && !titleLower.includes('desktop') && !titleLower.includes('pc ');
      ...
      } else if (!isLaptop && !isFullPC && (titleLower.includes('procesador') || titleLower.includes('intel core') || titleLower.includes('ryzen') || titleLower.includes('athlon') || titleLower.includes('pentium') || titleLower.includes('celeron') || titleLower.includes('motherboard') || titleLower.includes('tarjeta madre') || titleLower.includes('memoria ram') || titleLower.includes('tarjeta de video') || titleLower.includes('gtx') || titleLower.includes('rtx') || titleLower.includes('gt ') || titleLower.includes('geforce') || titleLower.includes('nvidia') || titleLower.includes('radeon rx') || titleLower.includes('rx ') || titleLower.includes('fuente de poder') || titleLower.includes('power supply') || titleLower.includes('case gamer') || titleLower.includes('chasis') || titleLower.includes('disco duro') || titleLower.includes('ssd') || titleLower.includes('nvme') || titleLower.includes('m.2') || titleLower.includes('grafica') || titleLower.includes('vga') || titleLower.includes('1030') || titleLower.includes('430') || titleLower.includes('amd'))) {
      ...
      if (category === 'componentes' && !isLaptop && !isFullPC) {
        ...
        else if (titleLower.includes('video') || titleLower.includes('gtx') || titleLower.includes('rtx') || titleLower.includes('gt ') || titleLower.includes('geforce') || titleLower.includes('nvidia') || titleLower.includes('radeon rx') || titleLower.includes('rx ') || titleLower.includes('grafica') || titleLower.includes('vga') || titleLower.includes('1030') || titleLower.includes('430')) subCategory = 'gpu';
